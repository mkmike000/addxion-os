...
- done: Firma `stadichair`, Person `jonas-braamt`. Pattern `wiki/patterns/bewertung-scan.md`.
- done: Butcher — keine Review-Löschung. Wahib — Fenster Anfang Februar, Waiting ohne 2026-09-01.
- done: Opportunities Bewertung-Scan + weitere Automation Stadichair + Automation Butcher ohne Review-Löschen. Kein Inbox „nächster Kunde“.
